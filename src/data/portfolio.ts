...
export const portfolioData = {
    ...
    stack: [
        { text: "React", icon: SiReact, color: "bg-blue-100 text-blue-800 border-blue-300" },
        { text: "TS", icon: SiTypescript, color: "bg-blue-100 text-blue-800 border-blue-300" },
        { text: "Tailwind", icon: SiTailwindcss, color: "bg-cyan-100 text-cyan-800 border-cyan-300" },
        { text: "Python", icon: SiPython, color: "bg-yellow-100 text-yellow-800 border-yellow-300" },
        { text: "FastAPI", icon: SiFastapi, color: "bg-teal-100 text-teal-800 border-teal-300" },
        { text: "Node & Express", icon: SiNodedotjs, color: "bg-green-100 text-green-800 border-green-300" },
        { text: "React Native", icon: SiReact, color: "bg-blue-100 text-blue-800 border-blue-300" },
        { text: "Flutter", icon: SiFlutter, color: "bg-cyan-100 text-cyan-800 border-cyan-300" },
        { text: "LangChain", icon: Link, color: "bg-emerald-100 text-emerald-800 border-emerald-300" },
        { text: "MongoDB", icon: SiMongodb, color: "bg-green-100 text-green-800 border-green-300" },
        { text: "Docker", icon: SiDocker, color: "bg-blue-100 text-blue-800 border-blue-300" },
        { text: "LangGraph", icon: Workflow, color: "bg-orange-100 text-orange-800 border-orange-300" },
        { text: "Gemini AI", icon: Sparkles, color: "bg-blue-100 text-blue-800 border-blue-300" },
        { text: "NestJS", icon: SiNestjs, color: "bg-red-100 text-red-800 border-red-300" }
    ],
    nav: [
