...
export default function Skills() {
  ...
  return (
    <section className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-20 flex flex-col items-start gap-12">
          ...
          return (
            <div 
              ...
              className={`
                ...
                ${isSpecial
                  ? "bg-gradient-to-br from-blue-50/80 to-sky-50/80 border-blue-100 shadow-xl shadow-blue-500/5 backdrop-blur-sm"
            ...
            >
              ...
              <div className="flex items-center justify-between mb-2">
                <h3 className={`text-xl font-['Bangers'] tracking-wide ${isSpecial ? "text-blue-600" : "text-gray-800"}`}>
                  {category.category}
                </h3>
                {isSpecial ? (
                ...
                {category.items.map((skill, idx) => (
                  <div 
                    ...
                    className={`
                      ...
                      ${isSpecial
                        ? "bg-white/60 border-blue-100 text-blue-900 hover:border-blue-300 hover:bg-white"
                        : "bg-white border-gray-100 text-gray-600 hover:border-blue-400 hover:text-blue-600"
                      }
                    `}
                  >
                    <skill.icon className={`w-4 h-4 ${isSpecial ? "text-blue-500" : "text-gray-600"}`} />
