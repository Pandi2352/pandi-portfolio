      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-blue-100/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-3xl -z-10"></div>
      ...
      {portfolioData.learningProjects && portfolioData.learningProjects.length > 0 && (
        <div className="mt-20 pt-0">
            <div className="relative mb-16 text-center reveal" data-reveal>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-blue-500/20 blur-[50px] rounded-full"></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 px-2">
                ...
                <a
                    ...
                    className="group relative flex flex-col bg-white rounded-3xl p-1 overflow-hidden hover:-translate-y-2 transition-all duration-500 shadow-sm hover:shadow-xl hover:shadow-blue-100/50 reveal"
                    data-reveal
                    style={{ transitionDelay: `${index * 150}ms` }}
                >
                    <div className="relative h-full bg-gradient-to-br from-white to-blue-50/30 rounded-[22px] p-6 flex flex-col z-20 overflow-hidden border border-blue-100/50">

                        {/* Subtle Glow Effects */}
                        <div className="absolute top-0 right-0 w-[150px] h-[150px] bg-blue-200/20 blur-[60px] rounded-full group-hover:bg-blue-300/30 transition-all duration-500"></div>
                        ...
                        <div className="flex justify-between items-start mb-6">
                            <div className="p-2.5 bg-white rounded-xl border border-blue-100 shadow-sm group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="mt-auto flex flex-wrap gap-2">
                            {project.tech.slice(0, 4).map((t, i) => (
                                <span key={i} className="px-2 py-1 bg-white text-blue-700 text-[10px] font-bold tracking-wider rounded border border-blue-100/50 shadow-sm">
                                    {t}
                                </span>
                            ))}
